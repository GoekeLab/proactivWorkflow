...
alternative promoters with proActiv. Our workflow provides a detailed, 
step-by-step guide for promoter analysis, with well-documented and reproducible 
examples. We demonstrate two use cases of proActiv that are prevalent and 
increasingly relevant in genomics and transcriptomics research. First, we 
analyse promoter activity using publicly available TCGA data, illustrating
how promoter usage is associated with cancer and normal samples. Secondly, we 
analyse promoter activity from single-cell data, showing how promoters
can be studied at the resolution of single cells. Our workflow represents the 
first single-cell analysis of promoters. Together, this article illustrates an
exploration of RNA-Seq data to study the role of alternative promoters and how 
they contribute to isoform expression.
